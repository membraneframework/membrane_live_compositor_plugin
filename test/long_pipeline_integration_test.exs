defmodule Membrane.VideoCompositor.LongPipelineTest do
  use ExUnit.Case
  ...
  test "Checks h264 pipeline on 30s 720p 30fps video" do
    ...
    output_path = "./test/fixtures/tmp_dir/output_30s_1280x1440.h264"
  ...
  test "Checks h264 pipeline on 60s 1080p 30fps video" do
    ...
    output_path = "./test/fixtures/tmp_dir/output_60s_1920x2160.h264"
