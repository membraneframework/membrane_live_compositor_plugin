defmodule Membrane.VideoCompositor.PipelineTest do
  ...
  test "Checks h264 pipeline on 2s 720p 30fps video" do
    input_paths = %{
    ...
    output_path = "./test/fixtures/tmp_dir/output_2s_1280x1440.h264"
  ...
  test "Checks h264 pipeline on 1s 1080p 30fps video" do
    input_paths = %{
    ...
    output_path = "./test/fixtures/tmp_dir/output_1s_1920x2160.h264"
