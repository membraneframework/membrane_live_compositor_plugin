defmodule Membrane.VideoCompositor.Test.Support.Utils do
  ...
  @type input_video_path :: binary()
  @type output_video_path :: binary()
  @type reference_video_path :: binary()
  ...
  @spec prepare_testing_video(
          ...
          {input_video_path(), output_video_path(), reference_video_path()}
  ...
  """
  @spec get_file_base_name(Membrane.RawVideo.t(), duration, extension) :: binary()
  ...
  """
  @spec generate_testing_video(input_video_path(), Membrane.RawVideo.t(), duration()) ::
          nil | :ok
  ...
  """
  @spec generate_ffmpeg_reference(input_video_path(), reference_video_path(), binary) ::
          nil | :ok
  ...
  @doc """
  Compare contents of two raw files, succeeding when `mse < allowed_error`
  """
  @spec compare_contents_with_error(binary(), binary(), float()) :: boolean()
  def compare_contents_with_error(output_path, reference_path, allowed_error \\ 2.5) do
    {:ok, reference_file} = File.read(reference_path)
    {:ok, output_file} = File.read(output_path)
