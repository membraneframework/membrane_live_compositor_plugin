defmodule Membrane.VideoCompositor.Test.Mock.FrameComposer.MultipleInput do
  @moduledoc """
  Mock frame composer for multiple input videos. It supports string buffers and concatenate them as an output.
  """
  @behaviour Membrane.VideoCompositor.FrameCompositor.MultipleInputs
