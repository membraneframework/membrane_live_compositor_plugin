defmodule Membrane.VideoCompositor.OpenGL.Native.Cpp do
  @moduledoc false
  use Unifex.Loader
end

defmodule Membrane.VideoCompositor.OpenGL.Native.Rust do
  @moduledoc false
  use Rustler,
...
defmodule Membrane.VideoCompositor.OpenGL.Native.Rust.RawVideo do
  @moduledoc """
