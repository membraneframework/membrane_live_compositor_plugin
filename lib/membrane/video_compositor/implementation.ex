defmodule Membrane.VideoCompositor.Implementation do
  ...
  def get_implementation_module(implementation) do
    case implementation do
      :ffmpeg ->
        {:ok, Membrane.VideoCompositor.Implementation.FFmpeg}

      :opengl_cpp ->
        {:ok, Membrane.VideoCompositor.Implementation.OpenGL.Cpp}

      :opengl_rust ->
        {:ok, Membrane.VideoCompositor.Implementation.OpenGL.Rust}
