...
void Compositor::join_frames(char *upper, char *lower, std::vector<char> &buffer) {
...
unsigned int Compositor::in_width() {
    return m_in_width;
}

unsigned int Compositor::in_height() {
    return m_in_height;
}

unsigned int Compositor::out_width() {
    return m_out_width;
}

unsigned int Compositor::out_height() {
    return m_out_height;
}